...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname |EX 21a|) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp")))))
...
( text(string-append (person-first-name person) (person-last-name person)) 20 "black")
) )
(person-image (make-person "Yidong" "Wang" 16 20 30))
(person-image (make-person "Pengfei" "Tan" 16 40 30))
